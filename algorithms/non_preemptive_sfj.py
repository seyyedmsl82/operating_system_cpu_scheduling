...
This algorithm sorts processes by the lowest burst time to the highest.
...
class NonPreemptiveSFJ(object):
    ...
    def get_next_important_time(self):
        ...
        """
        Find next important process in the timeline
        """
        
        # we have deleted process from list when we sent it into ready queue or running process
    ...
    def run(self):
        ...
        while self.processes or self.ready_queue or self.running_process:
            ...
            # sorting ready_queue by burst time
